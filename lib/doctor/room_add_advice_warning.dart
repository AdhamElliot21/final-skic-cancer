                    ...
                    child: Stack(
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(left: 210.0,top: 350),
                            child: Container(
                              height: 80,
                              width: 80,
                              ...
                              child: Center(
                                child: Text('add advice',textAlign: TextAlign.center,style: TextStyle(
                                  color: Colors.white,
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Text('add Warnnings',textAlign: TextAlign.center,style: TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 14,
                                ),),
